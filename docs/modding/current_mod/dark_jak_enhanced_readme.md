...
The **Dark Jak Enhanced** mod adds a full 3rd evolutionary stage to Dark Jak in Jak 2: the **Mega-Mega Dark Jak (Titan / Colossus)**, alongside critical quality-of-life and responsiveness fixes for Dark Jak's super abilities:
...
| [`goal_src/jak2/engine/target/target.gc`](file:///c:/Users/theol/Documents/Developpement/jak-project/goal_src/jak2/engine/target/target.gc) | Player Locomotion | Scaled jump velocity thresholds and allowed instant square press triggering in `target-jump`, `target-double-jump`, and `target-high-jump`. |
...
4. Jump and press **Square** to execute instant Dark Bomb; press **L1 + Square** near walls to test robust Dark Blast.
...
Le mod **Dark Jak Enhanced** ajoute un troisième stade d'évolution complet pour Dark Jak dans Jak 2 : le **Méga-Méga Dark Jak (Titan / Colosse)**, accompagné de correctifs majeurs de réactivité et de robustesse pour les super-pouvoirs :
...
| [`goal_src/jak2/engine/target/target.gc`](file:///c:/Users/theol/Documents/Developpement/jak-project/goal_src/jak2/engine/target/target.gc) | Locomotion du Joueur | Ajustement des seuils de vélocité et déclenchement instantané de la touche Carré dans les sauts. |
...
4. Sauter et appuyer sur **Carré** pour déclencher la Dark Bomb instantanée ; appuyer sur **L1 + Carré** près des murs pour tester le Dark Blast.
