...
Updates global memory layout boundaries for the Emotion Engine emulator in `memory_layout.h` and GOAL kernel definitions.
...
Met à jour les limites d'allocation de l'émulateur Emotion Engine dans `memory_layout.h` et les définitions du noyau GOAL.
