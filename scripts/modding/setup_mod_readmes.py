...
MODS_CONFIG = {
    ...
    "jak2/features/enhanced_city_traffic_v2": {
        ...
        "rebuild_binaries": False,
        "binaries_reason_en": "Not required. Operates purely through GOAL traffic scripts.",
        "binaries_reason_fr": "Non requise. Fonctionne exclusivement via les scripts de trafic en GOAL.",
        "extract_assets": False,
        "extract_reason_en": "Not required. Standard game extraction provides all vehicle models.",
        "extract_reason_fr": "Non requise. L'extraction standard fournit l'intégralité des véhicules.",
        ...
        "tech_summary_en": "Modifies traffic managers in `goal_src/jak2/engine/ai/traffic.gc` and zone spawn tables in `ctywide-init.gc`.",
        "tech_summary_fr": "Modifie les gestionnaires de trafic dans `goal_src/jak2/engine/ai/traffic.gc` et les tables d'apparition dans `ctywide-init.gc`."
    },
    ...
    "jak2/features/paddy_wagon_v2": {
        ...
        "rebuild_binaries": False,
        "binaries_reason_en": "Not required. Uses compiled OpenGOAL binaries.",
        "binaries_reason_fr": "Non requise. Fonctionne avec les binaires OpenGOAL existants.",
        "extract_assets": True,
        "extract_reason_en": "Required (`task extract`) to bake the Paddywagon art-group into city level files.",
        "extract_reason_fr": "Requise (`task extract`) pour cuire l'art-group du Paddywagon dans les niveaux de la ville.",
    ...
    "jak2/features/transport_v2": {
        ...
        "rebuild_binaries": False,
        "binaries_reason_en": "Not required. GOAL vehicle code and asset definitions are sufficient.",
        "binaries_reason_fr": "Non requise. Le code de véhicule en GOAL et les définitions d'assets suffisent.",
        "extract_assets": True,
        "extract_reason_en": "Required (`task extract`) to bake the transport drop-ship art-group into city DGOs.",
        "extract_reason_fr": "Requise (`task extract`) pour intégrer l'art-group du drop-ship dans les DGOs de la ville.",
