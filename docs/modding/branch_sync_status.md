...
| :--- | :---: | :--- | :--- | :--- |
| `jak2/config/custom_animation_and_sound` | ⚠️ Conflit | `b14fdf4ed - docs: synchronize updated modding documentation from master (AI-assisted)` | • `goalc/CMakeLists.txt` | `git checkout jak2/config/custom_animation_and_sound && git merge origin/master` |
...
| `jak2/features/jak3-jetBoard` | ⚠️ Conflit | `f39c79ac0 - docs: synchronize updated modding documentation from master (AI-assisted)` | • `goalc/CMakeLists.txt` | `git checkout jak2/features/jak3-jetBoard && git merge origin/master` |
