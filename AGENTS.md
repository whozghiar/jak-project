...
Our repository relies on 5 specialized GitHub Actions workflows. For a comprehensive pedagogical breakdown, see **[GitHub Actions Workflows Guide](docs/modding/tools/github_workflows.md)**:
...
Notre dépôt s'appuie sur 5 workflows GitHub Actions spécialisés. Pour un guide pédagogique complet, consultez le **[Guide des Workflows GitHub Actions](docs/modding/tools/github_workflows.md)** :
