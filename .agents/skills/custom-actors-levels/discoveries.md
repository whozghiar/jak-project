...
| 2026-09-20 | master-dev | Agent | Cross-game model adaptation (Jak 1/2/3) requires exact match of destination defskelgroup joint table; free bones or altered hierarchies corrupt joint channels. | `defskelgroup` joint matching & `retarget_anim` |
