...
;; Blue Crimson Guard mod -- City Peaceful. mod-city-peaceful.gc implements the squad behaviour;
;; mod-city-hooks.gc wires the *mod-city-*-hook* function pointers (engine/ai/traffic-h.gc) to it.
(goal-src "levels/city/traffic/citizen/mod-city-peaceful.gc" "traffic-manager")
(goal-src "levels/city/traffic/citizen/mod-city-hooks.gc" "mod-city-peaceful")
